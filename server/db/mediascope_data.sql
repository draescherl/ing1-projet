...
INSERT INTO `communiques` (`id`, `publi_date`, `title`, `cp_code`, `type`, `departement`, `theme`, `pdf_path`, `hyperlink`) VALUES
  (1, '2020-12-01', '[redacted] : Une semaine de chantier pour moderniser le réseau électrique de Castelnau Magnoac', 101, 1, 2, 9, NULL, NULL),
  (2, '2020-12-03', 'LA RESIDENCE OREKA : [redacted] ACCOMPAGNE BOUYGUES IMMOBILIER SUR LA ROUTE DE LA MOBILITE ELECTRIQUE', 102, 1, 2, 1, NULL, NULL),
...
INSERT INTO `retombees` (`id`, `publi_date`, `title`, `cp_code`, `type`, `departement`, `source`, `theme`, `conotation`, `pdf_path`, `hyperlink`) VALUES
  ...
  (2, '2020-12-03', 'Le quartier de la railliere a cauteret fait peau neuve grâce au SDE65 et [redacted] (facebook sde)', 103, 4, 3, 13, 9, 1, NULL, NULL),
  (3, '2020-12-04', '[redacted] Renove', 101, 1, 3, 16, 9, 1, NULL, NULL);